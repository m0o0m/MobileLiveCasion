package HistoryRoad {
	...
	public class DragonHistoryResultManager extends HistoryResultBaseManger {
		...
		public function DragonHistoryResultManager () {
			roadView=new Array();
		...
		public override function ShowRoad (strNumber:String):void {
			...
			arrResult = DragonResult(strNumber);
			if (arrResult) {
				if (resoultList==null) {
					resoultList = [0,0,0,0];
				}
		...
		private function DragonResult (strNumber:String):Array {
