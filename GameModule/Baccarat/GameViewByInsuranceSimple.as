package {
	...
	public class GameViewByInsuranceSimple extends GameViewByInsurance {

		public function GameViewByInsuranceSimple (prarentClass:GameClassByInsuranceSimple) {
			// constructor code
			super (prarentClass);
		...
		protected override function InitChipManager ():void {
			m_ChipManager= new ChipManagerByOneSimple();
